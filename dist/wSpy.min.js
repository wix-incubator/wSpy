!function(t){
	var i={};function n(e){
		if(i[e])return i[e].exports;var r=i[e]={i:e, l:!1, exports:{}};return t[e].call(r.exports, r, r.exports, n), r.l=!0, r.exports
	}n.m=t, n.c=i, n.d=function(t, i, e){
		n.o(t, i)||Object.defineProperty(t, i, {enumerable:!0, get:e})
	}, n.r=function(t){
		'undefined'!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t, Symbol.toStringTag, {value:'Module'}), Object.defineProperty(t, '__esModule', {value:!0})
	}, n.t=function(t, i){
		if(1&i&&(t=n(t)), 8&i)return t;if(4&i&&'object'==typeof t&&t&&t.__esModule)return t;var e=Object.create(null);if(n.r(e), Object.defineProperty(e, 'default', {enumerable:!0, value:t}), 2&i&&'string'!=typeof t)for(var r in t)n.d(e, r, function(i){
			return t[i]
	...
	'use strict';function e(t, i){
		...
		const i=t.wSpyOverrideParam, n=t.settings, u=o(), c=u?i||function(t){
			...
			}.bind(this), frame:window, wSpyParam:c, settings:Object.assign({}, s, n)}:{}), a={};if(Object.keys(h).forEach(function(t){
			return e(this, this), a[t]=function(){
				e(this, this)
			}.bind(this)
		}.bind(this)), !c)return a;try{
			const t=function(){
				try{
	...
	'use strict';function e(t, i){
		...
		const i=t.Error, n=t.frame, o=t.settings, u=t.wSpyParam, c=t.memoryUsage;return{ver:4, logs:{}, otherSpies:[], init(){
			if(!this.includeLogs){
				const t=(u||'').split(',').filter(function(t){
						return e(this, this), '-'!==t[0]
					}.bind(this)).filter(function(t){
						return e(this, this), t
					}.bind(this)), i=(u||'').split(',').filter(function(t){
						return e(this, this), '-'===t[0]
					}.bind(this)).map(function(t){
						return e(this, this), t.slice(1)
					}.bind(this));this.includeLogs=o.includeLogs.split(',').concat(t).filter(function(t){
					return e(this, this), -1===i.indexOf(t)
				}.bind(this)).reduce(function(t, i){
			...
			}(t)?this.merged(function(i){
					return e(this, this), t.test(i.join(' '))
				}.bind(this)):s(t)?this.merged(function(i){
					return e(this, this), -1!==i.join(' ').indexOf(t)
				}.bind(this)):Number.isInteger(t)?this.merged().slice(-1*t):void 0
			...
			const i=-1*(t||o.DEFAULT_LOGS_COUNT);Object.keys(this.logs).forEach(function(t){
			...
			return[].concat.apply([], Object.keys(this.logs).filter(function(t){
				return e(this, this), Array.isArray(this.logs[t])
			}.bind(this)).map(function(t){
				return e(this, this), this.logs[t].map(function(i){
					e(this, this);const n=[i.index, t, ...i];return r.forEach(function(t){
						e(this, this), n[t]=i[t]
					}.bind(this)), n
				}.bind(this))
			}.bind(this))).filter(function(i, n, r){
				return e(this, this), !t||t(i, n, r)
			}.bind(this)).sort(function(t, i){
				return e(this, this), t.index-i.index
			}.bind(this))
		}, grouped(t){
			const i=this.merged(t), n=-1*o.DEFAULT_LOGS_COUNT;return[].concat.apply([], i.reduce(function(t, i, n, s){
			...
			}.bind(this))).slice(n).map(function(t, i, n){
				e(this, this);const r=0===i?0:t.time-n[i-1].time;return t[0]=`${t[0]} +${r}`, t
			}.bind(this));function r(t){
				const i=[t];return i.time=t.time, i
			}
		}, groupedNoMobx(t){
			return this.grouped(function(i, n, r){
				return e(this, this), 'mobx'!==i[1]&&(!t||t(i, n, r))
			}.bind(this))
		}, source(t){
			i.stackTraceLimit=50;const r=[n];for(;r[0].parent&&r[0]!==r[0].parent;)r.unshift(r[0].parent);let s=r.reverse().map(function(t){
				return e(this, this), (new t.Error).stack
			}.bind(this)).join('\n').split(/\r|\n/).map(function(t){
				return e(this, this), t.trim()
			}.bind(this)).slice(4).filter(function(t){
